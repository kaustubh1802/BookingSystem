   ...
   <div className={type === "list" ? "headerContainer listMode" : "headerContainer"} >
    ...
    {type !== "list" &&
     <>
      ...
      <p className="headerDesc">Get rewarded for your travels unlock instant saving of 10% or more with a free Raptor account</p>
      ...
      <div className="headerSearch">
       ...
       <div onClick={() => setOpenOption(!openOptions)} className="headerSearchItem">
